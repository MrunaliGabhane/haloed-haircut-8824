...
<Box>
    ...
    <Image src="https://www.elpolloloco.com/content/img/chicken-leg_1280.webp"/>
      ...
      <Text position="absolute" top="49%" left="45%" color='red' fontWeight="bold" fontSize="50px" >
        OUR FOOD
      </Text>
      <Text position="absolute" top="52%" left="41%" width="25%" fontWeight='bold' fontSize="1.5xl" textAlign="center" >
      Streeped in tradition. Filled with freshness. Our menu is the intersection of our Sinaloan roots and our Socal hometown.
      </Text>
      
      <Button _hover={{ bg: "red", color: "white" }} position="absolute" top="56%" left="49%" fontSize="xl"  color={'white'} background={'blue'}>
        <Link to="/allPage">
        VIEW MENU
        </Link>
      </Button>
