    ...
    return (
      <>
        ...
        >
          ...
          >
              <Text > HOME</Text>
              <Text > <Link to='/allPage'>OUR FOOD</Link></Text>
        ...
        <Flex
          ...
          >
             ...
             */}
             <Flex  >
          <Link to="/loginPage">
          <Text padding={"10px 15px 8px 15px"} color={"red"} fontWeight={"bold"}  _hover={{color:"blue"}}>Sign In</Text>
          </Link>
          <Link to="/registerPage">
          <Text padding={"10px 15px 8px 15px"} color={"red"} fontWeight={"bold"}  _hover={{color:"blue"}}>Register</Text>
          </Link>
